...
''' 
def func_converter_imagens(path_origem,path_destino, quantidade):
            ...
            try:
                ...
                if(format_imagem >= 1 and format_imagem <= 4):
                    ...
                    if pausar == 'n':
                        ...
                        # Faz a conversão das imagens após as escolhas
                        convert_(path_origem, path_destino, tipo)
                        tempo = (time.time() - upload_time)
                    ...
                    if tempo < 60:
                        ...
                        print(f"Conversão das imagens concluída com sucesso.\nO resultado está na pasta: {path_destino}")
                        print(timeDuration)
                        print("Digite (y) Para abrir a pasta com as imagens convertidas... ou")
                        pausar = input("\nPressione uma tecla.. para continuar! ")
                        if(pausar == 'y'):
